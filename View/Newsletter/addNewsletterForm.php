<h3 class="text-center" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html"
    xmlns="http://www.w3.org/1999/html">Gestion des newsletters </h3>
<br>
    ...
    <div class="container-fluid">
        <div class="row animate-box">
            <div class="row">
                ...
                -->
                <div  class="list list-unstyled" id="bodyHtmlContenuNewsletter"></div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div id="modalContentNewsletter" class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal formActionNewsletter" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea class="form-control inputContenu" style="text-align: center" id="inputContenu" name="inputContenu" value=""></textarea>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btnSubmitNewsletter buttonValide">Enregistrer</button>
            </div>
        </div>
    </div>
</div>
